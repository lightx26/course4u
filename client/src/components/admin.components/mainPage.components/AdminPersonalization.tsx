...
const AdminPersonalization = ({avatarUrl}: { avatarUrl?: string }) => {
    ...
    const adminDisplayName: string = adminData.fullName ? adminData.fullName : adminData.username ? adminData.username : "Admin";
        ...
        <div className="absolute right-0.5 mt-1 w-60 bg-white rounded-xl shadow-lg z-50">
            ...
            >
                <div className="personalizaion h-[44%] border-b-2">
                    ...
                    <div
                        className="name max-w-[200px] max-h-[28px] line-clamp-1 text-center mx-auto justify-center text-xl font-semibold overflow-hidden overflow-ellipsis">
                        {adminDisplayName}
                    </div>
                    <div
                        className="email max-w-[150px] max-h-[20px] line-clamp-1 text-center mx-auto text-sm font-semibold overflow-hidden overflow-ellipsis">
                        {adminData.email}
                    </div>
                </div>
