...
export default function UserCard({ avatarUrl }: { avatarUrl: string }) {
  ...
  return (
    <div className="pt-2 mt-2 bg-white border border-gray-200 rounded-md shadow-xl w-60">
      ...
      <div>
        ...
        <a
          className="flex items-center gap-4 px-4 py-2 text-gray-800 hover:bg-gray-100 cursor-pointer"
          onClick={goToMyScorePage}
        >
          <PieChartIcon />
          <div className="w-full font-medium">My score</div>
        </a>
      </div>
      <hr></hr>
