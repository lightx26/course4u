    ...
    return (
        <div className="flex justify-between text-base cursor-pointer text-[#4E5566] hover:text-[#7E22CE]" onClick={onFilterItemClick}>
            <div className="flex items-center gap-2">
                <input className="sr-only" type='checkbox' id={prop.id} checked={checked} onChange={onFilterItemClick} readOnly />
                <div className={`w-4 h-4 rounded border ${checked ? 'bg-purple-600 border-transparent' : 'border-gray-400'} flex items-center justify-center`}>
