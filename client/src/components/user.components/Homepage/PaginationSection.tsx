        ...
        <Pagination>
            <PaginationContent>
                ...
                <PaginationItem key={1}>
                    <PaginationLink className={currentPage == 1 ? 'bg-purple-600 text-white' : ''} onClick={(event) => handlePageClick(event, 1)}>1</PaginationLink>
                </PaginationItem>
                {
                    currentPage > 4 ?
                ...
                {/* Render các trang từ startPage đến endPage */
                    ...
                    <PaginationItem key={page}>
                        <PaginationLink className={currentPage == page ? 'bg-purple-600 text-white' : ''} onClick={(event) => handlePageClick(event, page)}>
                            {page}
                        </PaginationLink>
                    </PaginationItem>
                ))}
                {
                    ...
                    <PaginationItem>
                        ...
                        <PaginationLink className={currentPage == lastPage - 1 ? 'bg-purple-600 text-white' : ''} onClick={(event) => handlePageClick(event, lastPage - 1)}>{lastPage - 1}</PaginationLink>
                    </PaginationItem>
