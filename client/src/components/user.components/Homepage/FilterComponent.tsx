                ...
                <div className='p-3 ease-linear delay-75'>
                    {
                        ...
                        <div className='relative w-full py-2'>
                            <input type='search' className='w-full p-2 bg-white border border-gray-300 rounded-md hover:border-purple-600' />
                            <svg className='absolute top-1/2 right-1 -translate-y-2/4 hover:stroke-purple-600' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path d="M15.5 15.5L20 20" stroke="#1D2026" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <circle cx="10.5" cy="10.5" r="5.75" stroke="#1D2026" stroke-width="1.5" />
                            </svg>
                        </div>
                    }
