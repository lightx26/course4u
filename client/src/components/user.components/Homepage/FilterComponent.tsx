...
export default function FilterComponent(prop: Prop) {
    ...
    return (
        <div className='text-black bg-white border border-gray-300 border-solid rounded-lg max-w-64'>
            <div className='flex justify-between p-2 border border-gray-300 border-solid rounded-lg max-w-64' onClick={toggleListVisibility}>
                <h3>{prop.title}</h3>
                ...
                <div className='p-3 ease-linear delay-75'>
                    {prop.isHaveSearch && (
                        <div className='relative py-2'>
                            <input onChange={handleSearchChange} type='text' className='box-border block py-2 bg-white border border-gray-300 rounded-md max-w-[232px] px-7 hover:border-violet-600' />
