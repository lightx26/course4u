...
export default function FilterWrap() {
    ...
    return (
        <div className='max-h-[90vh] custom-scrollbar overflow-y-auto border-2 border-gray-100 border-solid p-2 rounded-md w-full'>
            <div className='flex flex-col w-full gap-5 pb-12 select-none min-w-64'>
