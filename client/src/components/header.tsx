    ...
    <header className="bg-white shadow-md p-4">
      <div className="container mx-auto max-w-screen-xl flex justify-between items-center">
        <div className="flex items-center" style={{ cursor: "pointer" }}>
          ...
          <span
            style={{ color: "black", fontSize: "1.7rem", fontWeight: "600" }}
          >
            ourse4U
          </span>
        </div>
        ...
        <div
          className="flex-grow mx-4 px-16"
          style={{
            display: "flex",
            justifyItems: "center",
            alignItems: "center",
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            ...
            {isDropdownAvatarOpen && (
              <div className="absolute right-0 mt-2 w-60 bg-white border border-gray-200 rounded-md shadow-lg pt-2">
                <div
                  style={{
                    padding: "10px 0px",
