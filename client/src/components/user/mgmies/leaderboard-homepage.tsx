...
import LeaderboardItem from "./leaderboard-item-in-homepage";
import { getDataLeaderBoard } from "../../../service/score";
type DataResponse = {
    avatarUrl: string;
    email: string;
    fullName: string;
    ...
    const fetchDataLeaderBoardHomepage = async () => {
        try {
            ...
            if (result && result.leaderboardUserDTOs) {
                const dataTmp: DataLeaderBoardHomepage[] =
                    result.leaderboardUserDTOs
                        .slice(0, 5)
