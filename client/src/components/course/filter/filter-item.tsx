...
export default function FilterItemComponent({
    ...
    return (
        <div
            className='flex max-w-60 justify-between text-sm cursor-pointer text-[#4E5566] hover:text-[#7E22CE]'
        ...
        >
            <div className='flex items-center gap-2 max-w-60'>
                ...
                <div
                    className='text-[13px] line-clamp-1 h-[20px] overflow-ellipsis max-w-[170px]'
                    title={prop.name}
                >
                    {prop.name}
                </div>
