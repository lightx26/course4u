...
import "../../assets/css/detail-of-course.css";
import "react-dropdown/style.css";

import RatingDetail from "../../components/course/rating-status.tsx";
import CommentDetail from "../../components/course/comment-detail.tsx";
import PaginationSection from "../../components/shared/pagination-section.tsx";
import CourseCardComponent from "../../components/course/grid-view/course-card.tsx";
import { RootState } from "../../redux/store/store.ts";
import ModalEditOrDeleteCourse from "../../components/modal/modal-edit-or-delete-course.tsx";
...
import defaultThumbnail from "../../../public/course/default-course-thumnail.svg";
...
const Detail_Of_Course: React.FC = () => {
    ...
    const getDataDetailCourse = async (id: string | undefined) => {
        ...
        if (result && result.data) {
            result.data.thumbnailUrl = handleThumbnailUrl(
                                        ...
                                        <div className='mt-[10px] flex justify-center items-center gap-[20px]'>
                                            <div className='border border-[#ccc] w-[20%] h-full flex flex-col justify-center items-center p-[10px_15px]'>
                                                <div className='text-[2rem] font-[600] mb-[15px]'>
                                                    {dataRatings?.averageRating.toFixed(
                                                        1
                                                    )}
                                                </div>
                            ...
                            <div className='max-w-[1536px] mx-auto pl-[10%] pr-[5%] pt-[20px]'>
                                ...
                                <div className='flex justify-between items-center w-full flex-wrap pb-[80px]'>
                                    {dataRelatedCourse &&
                                        dataRelatedCourse.length === 0 && (
                                            <div>
                                                There are no results related to
                                                this course
                                            </div>
                                        )}
                                    {(trackingIndex === 1 ||
                                        dataRelatedCourse.length <= 4) && (
